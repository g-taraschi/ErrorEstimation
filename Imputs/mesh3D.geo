...
//wellbore dimensions
Lw = 1;   // wellbore length
Rw = 0.2; // wellbore radius
...
p_res = 1.6;  // progression coefficient of the reservoir mesh
p_well = 0.3; // progression coefficient of the wellbore mesh (bump scheme)
